...
$credencialesFile = __DIR__ . '/credenciales.txt';

if(!file_exists($credencialesFile)) {
    die('Error: No se encuentra el archivo credenciales.txt');
}

$credencialesJson = file_get_contents($credencialesFile);
$credenciales = json_decode($credencialesJson, true);

if(!$credenciales) {
    die('Error: No se pudieron leer las credenciales');
}
